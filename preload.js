...
// Changed to 'electron' to match your React app usage
contextBridge.exposeInMainWorld('electron', {
  ...
  // Meta Tag Verification APIs
  checkVerification: (domain) => ipcRenderer.invoke('check-verification', domain),
  generateVerification: (domain) => ipcRenderer.invoke('generate-verification', domain),
  verifyDomain: (domain, verificationId) => ipcRenderer.invoke('verify-domain', domain, verificationId),
